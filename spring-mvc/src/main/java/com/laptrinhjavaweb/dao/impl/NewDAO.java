...
public class NewDAO extends AbstractDAO<NewModel> implements INewDAO {
	...
	public List<NewModel> findAll(Pageble pageble) {
		...
		if (pageble.getSorter() != null && org.springframework.util.StringUtils.isEmpty(pageble.getSorter().getSortName())!=true && org.springframework.util.StringUtils.isEmpty(pageble.getSorter().getSortBy())!=true) {
